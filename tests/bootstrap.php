...
$dbAdapter = Zend_Db::factory($dbConfig->dbStart->db->adapter, array(
    'host'     => $dbConfig->dbStart->db->host,
    'username' => $dbConfig->dbStart->db->username,
    'password' => $dbConfig->dbStart->db->password,
    'dbname'   => $dbConfig->dbStart->db->dbname
));
